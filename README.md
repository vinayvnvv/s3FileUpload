...
| `s3-file-model`  | no value | must be used with child input[type=file] element,then this element will be the file holder(file model), this attribute has no value          | required |  - 
